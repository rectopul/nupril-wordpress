...
$.extend($.validator, {
	...
	messages: {
		...
		creditcard: "Por favor, insira um n&uacute;mero de cartão de cr&eacute;dito v&aacute;lido.",
		equalTo: "Por favor repita o valor.",
		accept: "Por favor insira um valor com a extens&atilde;o v&aacute;lida.",
		maxlength: $.validator.format("M&aacute;ximo de caracteres: {0}."),
		minlength: $.validator.format("M&iacute;nimo de caracteres: {0}."),
		rangelength: $.validator.format("M&iacute;nimo de {0} e m&aacute;ximo de {1} caracteres."),

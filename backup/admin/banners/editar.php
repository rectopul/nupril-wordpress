<?php 
		...
		$busca_dados = mysql_query("SELECT * FROM tb_banners WHERE id = '$id_editar'");
		...
		// Gera o apelido
		$apelido = GeraApelidoBanner($_POST['nome'], "-", $id_editar);
		if($apelido == "Apelido em uso") { $erro = "152"; }
		...
		// Imagem 1
		if ($imagem_1 != "") {
		rename("../../_imagens/banners/".$imagem_1."", "../../_imagens/banners/".$apelido."_1.jpg");
		rename("../../_imagens/banners/miniaturas/".$imagem_1."", "../../_imagens/banners/miniaturas/".$apelido."_1.jpg");
		$imagem_1 = $apelido."_1.jpg";
		}
		// Imagem 2
		if ($imagem_2 != "") {
		rename("../../_imagens/banners/".$imagem_2."", "../../_imagens/banners/".$apelido."_2.jpg");
		rename("../../_imagens/banners/miniaturas/".$imagem_2."", "../../_imagens/banners/miniaturas/".$apelido."_2.jpg");
		$imagem_2 = $apelido."_2.jpg";
		}
		// Imagem 3
		if ($imagem_3 != "") {
		rename("../../_imagens/banners/".$imagem_3."", "../../_imagens/banners/".$apelido."_3.jpg");
		rename("../../_imagens/banners/miniaturas/".$imagem_3."", "../../_imagens/banners/miniaturas/".$apelido."_3.jpg");
		$imagem_3 = $apelido."_3.jpg";
		}
		// Imagem 4
		if ($imagem_4 != "") {
		rename("../../_imagens/banners/".$imagem_4."", "../../_imagens/banners/".$apelido."_4.jpg");
		rename("../../_imagens/banners/miniaturas/".$imagem_4."", "../../_imagens/banners/miniaturas/".$apelido."_4.jpg");
		$imagem_4 = $apelido."_4.jpg";
		}
		// Imagem 5
		if ($imagem_5 != "") {
		rename("../../_imagens/banners/".$imagem_5."", "../../_imagens/banners/".$apelido."_5.jpg");
		rename("../../_imagens/banners/miniaturas/".$imagem_5."", "../../_imagens/banners/miniaturas/".$apelido."_5.jpg");
		$imagem_5 = $apelido."_5.jpg";
		}
		// Imagem 6
		if ($imagem_6 != "") {
		rename("../../_imagens/banners/".$imagem_6."", "../../_imagens/banners/".$apelido."_6.jpg");
		rename("../../_imagens/banners/miniaturas/".$imagem_6."", "../../_imagens/banners/miniaturas/".$apelido."_6.jpg");
		$imagem_6 = $apelido."_6.jpg";
		}
		// Imagem 7
		if ($imagem_7 != "") {
		rename("../../_imagens/banners/".$imagem_7."", "../../_imagens/banners/".$apelido."_7.jpg");
		rename("../../_imagens/banners/miniaturas/".$imagem_7."", "../../_imagens/banners/miniaturas/".$apelido."_7.jpg");
		$imagem_7 = $apelido."_7.jpg";
		}
		// Imagem 8
		if ($imagem_8 != "") {
		rename("../../_imagens/banners/".$imagem_8."", "../../_imagens/banners/".$apelido."_8.jpg");
		rename("../../_imagens/banners/miniaturas/".$imagem_8."", "../../_imagens/banners/miniaturas/".$apelido."_8.jpg");
		$imagem_8 = $apelido."_8.jpg";
		}
			
		// Registra no banco de dados
		$editar = "UPDATE tb_banners SET 	nome = '$nome',
											apelido = '$apelido',											
		...
		// Se editar
		if($editar_exec) {
		header('Location:index.php?sucesso=151');
		} else {
		$erro = "151";
		}
		...
		if(mysql_num_rows($busca_categorias) == 0) { header('Location:index.php?erro=154'); }
...
<title><?php echo $titulo_sistema; ?> :: Editar banner</title>
...
<div id="defesa">
	...
	<h1 id="barra-esquerda-titulo"><a href="#"><?php echo $titulo_sistema; ?></a></h1>
      ...
      <div id="conteudo">
			...
			<!-- INTRODUÇÃO -->
			<h2>Editar banner</h2>
			<p id="introducao">Utilize o formul&aacute;rio abaixo para editar o banner.</p>
			...
			<div class="miolo">
				...
				<div class="miolo-cabecalho">
					<h3 class="tit-longo visivel">Dados do banner</h3>
                </div>
				<!-- FIM DO CABEÇALHO -->             
			  ...
			  <div class="miolo-conteudo">
                    ...
                    <form id="formulario-interno" class="formulario estilo" action="editar.php" method="post">
              		<input type="hidden" name="id" value="<?php echo $id_editar; ?>" />
						...
						<input class="input-texto input-medio required" type="text" id="nome" name="nome" value="<?php echo $dados['nome']; ?>" maxlength="255" /><br />
                       	...
                       	<p>
                        <label>Posição (Número para ordenar):</label>
						<input class="input-texto input-minimo required" type="text" id="hierarquia" name="hierarquia" value="<?php echo $dados['hierarquia']; ?>" maxlength="255" />
                        </p>
                        ...
                        <option value="ativo" <?php if($dados['status'] == "ativo") { echo'selected="selected"'; } ?> >Ativo</option>
                        <option value="inativo" <?php if($dados['status'] == "inativo") { echo'selected="selected"'; } ?> >Inativo</option>
                        </select>
						</p>
                        
						<p>
                        <label>Link (Não é obrigatório):</label>
						<textarea class="input-texto textarea" id="link" name="link" cols="79" rows="2" ><?php echo $dados['link']; ?></textarea><br />
                        <small>Ex.: http://www.nupill.com.br/lancamentos.php</small>
                        </p>
 
                        </fieldset>
                    <fieldset>
                      <legend>Imagem do banner</legend>
                    </fieldset>
					<?php if ($dados['imagem_1'] != "") { echo'
                    <input type="hidden" name="imagem_nome_1" class="required" id="imagem_nome_1" value="'.$dados['imagem_1'].'" />';
                    } else { echo'
                    ...
                    <p><span class="nota">Dica:</span> As imagens devem estar no formato <strong>.jpg.  Resolução de 960px x 340px.</strong>. O tamanho m&aacute;ximo &eacute; de <strong>2Mb</strong>. Procure manter imagens menores em seu site, imagens maiores demoram para ser carregadas e prejudicam a experi&ecirc;ncia do usu&aacute;rio.</p>
                    <p><label for="imagem_nome_1" class="invalido" id="erro_img">Por favor, insira uma imagem no campo abaixo [ Imagem ].</label></p>
                    </form>
                            ...
                            <?php if ($dados['imagem_1'] != "") { echo'
                            <img src="../../_imagens/banners/'.$dados['imagem_1'].'" width="100%" />';
                            } else { echo'
                        ...
                        <div class="segunda_linha" <?php if($dados['imagem_3'] != "") { echo'style="display:block;"'; } ?> >
                          ...
                          <div id="div_imagem_3" class="div_imagem">
                            ...
                            <img src="../../_imagens/banners/'.$dados['imagem_3'].'" width="100%" />';
                            } else { echo'
                            ...
                            <img src="../../_imagens/banners/'.$dados['imagem_4'].'" width="100%" />';
                            } else { echo'
                        ...
                        <div class="terceira_linha" <?php if($dados['imagem_5'] != "") { echo'style="display:block;"'; } ?> >
						  ...
						  <div id="div_imagem_5" class="div_imagem">
                            ...
                            <img src="../../_imagens/banners/'.$dados['imagem_5'].'" width="100%" />';
                            } else { echo'
                          ...
                          <div id="div_imagem_6" class="div_imagem">
                            ...
                            <img src="../../_imagens/banners/'.$dados['imagem_6'].'" width="100%" />';
                            } else { echo'
					  ...
					  <?php } ?>
                        ...
                        <div class="quarta_linha" <?php if($dados['imagem_7'] != "") { echo'style="display:block;"'; } ?> >
                          ...
                          <div id="div_imagem_7" class="div_imagem">
                            ...
                            <img src="../../_imagens/banners/'.$dados['imagem_7'].'" width="100%" />';
                            } else { echo'
                          ...
                          <div id="div_imagem_8" class="div_imagem">
                            ...
                            <img src="../../_imagens/banners/'.$dados['imagem_8'].'" width="100%" />';
                            } else { echo'
                        ...
                        <p><input class="botao grande" type="button" id="enviarform" value="Salvar Altera&ccedil;&otilde;es" />&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<input class="botao grande" type="button" onclick="window.location.href='../banners'" value="Cancelar" /></p>
						<div class="clear"></div>
					</form>
...
<script type="text/javascript" src="../_scripts/jquery.banners.js"></script>
<!--[if IE 6]>

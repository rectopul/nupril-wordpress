<?php 
		...
		// Gera o apelido
		$apelido = GeraApelidoBanner($_POST['nome'], "-", 0);
		...
		$inserir = "INSERT INTO tb_banners (
											nome,
											apelido,
											hierarquia,
											link,
		...
		// Se inserir
		if($inserir_exec) {
		header('Location:index.php?sucesso=150');
		} else {
		$erro = "150";
		}
...
<title><?php echo $titulo_sistema; ?> :: Adicionar banner</title>
...
<div id="defesa">
	...
	<h1 id="barra-esquerda-titulo"><a href="#"><?php echo $titulo_sistema; ?></a></h1>
        ...
        <div id="conteudo">
			...
			<p id="introducao">Utilize o formul&aacute;rio abaixo para adicionar um novo banner.</p>
			...
			<div class="miolo">
				...
				<div class="miolo-conteudo">
                    ...
                    <form id="formulario-interno" class="formulario estilo" action="adicionar.php" method="post">
						...
						<input class="input-texto input-minimo required" type="text" id="hierarquia" name="hierarquia" value="<?php echo $hierarquia; ?>" maxlength="255" />
                        </p>
						...
						<textarea class="input-texto textarea" id="link" name="link" cols="79" rows="5" ><?php echo $link; ?></textarea><br />
                    ...
                    <p><span class="nota">Dica:</span> As imagens devem estar no formato <strong>.jpg</strong>. Resolução de 960px x 340px. O tamanho m&aacute;ximo &eacute; de <strong>2Mb</strong>. Procure manter imagens menores em seu site, imagens maiores demoram para ser carregadas e prejudicam a experi&ecirc;ncia do usu&aacute;rio.</p>
                    <p><label for="imagem_nome_1" class="invalido" id="erro_img">Por favor, insira uma imagem no campo abaixo [ Imagem].</label></p>
                            ...
                            <?php if ($imagem_1 != "") { echo'
                            <img src="../../_imagens/banners/'.$imagem_1.'" width="100%" />';
                            } else { echo'
                        ...
                        <div class="segunda_linha" <?php if($imagem_3 != "") { echo'style="display:block;"'; } ?> >
                          ...
                          <div id="div_imagem_3" class="div_imagem">
                            ...
                            <img src="../../_imagens/banners/'.$imagem_3.'" width="100%" />';
                            } else { echo'
                          ...
                          <div id="div_imagem_4" class="div_imagem">
                            ...
                            <img src="../../_imagens/banners/'.$imagem_4.'" width="100%" />';
                            } else { echo'
                    ...
                    <div class="terceira_linha" <?php if($imagem_5 != "") { echo'style="display:block;"'; } ?> >
						  ...
						  <div id="div_imagem_5" class="div_imagem">
                            ...
                            <img src="../../_imagens/banners/'.$imagem_5.'" width="100%" />';
                            } else { echo'
                          ...
                          <div id="div_imagem_6" class="div_imagem">
                            ...
                            <img src="../../_imagens/banners/'.$imagem_6.'" width="100%" />';
                            } else { echo'
					  ...
					  <?php } ?>
                        ...
                        <div class="quarta_linha" <?php if($imagem_7 != "") { echo'style="display:block;"'; } ?> >
                          ...
                          <div id="div_imagem_7" class="div_imagem">
                            ...
                            <img src="../../_imagens/banners/'.$imagem_7.'" width="100%" />';
                            } else { echo'
                          ...
                          <div id="div_imagem_8" class="div_imagem">
                            ...
                            <img src="../../_imagens/banners/'.$imagem_8.'" width="100%" />';
                            } else { echo'
                        ...
                        <p><input class="botao grande" type="button" id="enviarform" value="Adicionar Banner" />&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<input class="botao grande" type="button" onclick="window.location.href='../banners'" value="Cancelar" /></p>
						<div class="clear"></div>
					</form>

...
<title><?php echo $titulo_sistema; ?> :: Marcas</title>
...
<div id="defesa">
	...
	<h1 id="barra-esquerda-titulo"><a href="#"><?php echo $titulo_sistema; ?></a></h1>
      ...
      <div id="conteudo">			
			<!-- INTRODUÇÃO -->
			<h2>Marcas / Produtores</h2>
            <p id="introducao">Administre aqui as marcas/produtores.</p>
            ...
            <ul class="atalhos">
                ...
                <li><a class="botao-atalho" href="adicionar-marca.php" title="Adicionar Marca"><span>
                <img src="../_imagens/atalhos/ad_marca.png" alt="Adicionar Marca" /><br />
                    Adicionar Marca/Produtor</span></a></li>
	    ...
	    <div class="clear"></div>
			...
			<div class="miolo" style="position:relative">
				...
				<div class="miolo-cabecalho">
					<h3 class="tit-longo visivel">Marcas / Produtores</h3>
                </div>
				<!-- FIM DO CABEÇALHO -->             
				...
				<div class="miolo-conteudo">
                    ...
                    <!-- LISTAGEM -->
 	  				<div class="conteudo-box"> 
                        ...
                        <!-- FILTRAGEM -->
                        <div class="filtragem">
                        <form id="formulario-filtro" class="formulario" action="marcas.php<?php echo $link_filtro; ?>" method="post">
                        ...
                        <a class="limpar" href="marcas.php<?php echo $link_filtro; ?>" title="Limpar busca">[X] Limpar</a></p>
						<?php } ?>                        
                        </form>
                        </div>
                        <!-- FIM DA FILTRAGEM -->
                          ...
                          <tfoot>
                            <tr>
                                  <td colspan="6">
                                      ...
                                      <!-- PAGINAÇÃO -->
                                      <div class="paginacao">
                                          <?php if($ini_busca !=0) { ?><a href="marcas.php<?php echo $link_paginacao; ?>&ini=<?=$anterior_ini?>" title="P&aacute;gina anterior">&laquo; Anterior</a><? } 
										  ...
										  ?>
                                          <a href="marcas.php<?php echo $link_paginacao; ?>&ini=<?=$pagina_contagem?>" class="numero <?php echo $class_ativa; ?>" title="<?php echo $i; ?>"><?php echo $i; ?></a>
                                          <?php } if($num_resul_total > $proximo_ini) { ?>
                                          <a href="marcas.php<?php echo $link_paginacao; ?>&ini=<?=$proximo_ini?>" title="Pr&oacute;xima p&aacute;gina">Pr&oacute;xima &raquo;</a>
                                          <?php } ?>
                                      </div>
                                      <!-- FIM DA PAGINAÇÃO -->
                                      <?php } ?>
                            ...
                            <tbody>
								...
								while($dados_marca = mysql_fetch_array($busca_visual)) { 							

								?>
                            	<!-- ITEM -->
                              	<tr>
                                  	<td><?php echo Resumo($dados_marca['nome'],30); ?></td>
                                    <td title="<?php echo $dados_marca['descricao']; ?>"><?php echo Resumo($dados_marca['descricao'],30); ?></td>
                                    <td><?php echo DataSimples($dados_marca['data_cadastro']); ?></a></td>
                                    <td><?php echo Resumo($dados_marca['nome_responsavel'],30); ?></td>
                                    <td><?php echo ucfirst($dados_marca['status']); ?></td>
                                    <td>                                    
                                    <a href="editar-marca.php?id=<?php echo $dados_marca['id']; ?>" title="Editar <?php echo $dados_marca['nome']; ?>"><img src="../_imagens/icones/editar.png" alt="Editar <?php echo Resumo($dados_marca['nome'],30); ?>" /></a>
                                    <a href="status-marca.php?a=box&id=<?php echo $dados_marca['id']; ?>" rel="modal" title="Alterar status da marca <?php echo Resumo($dados_marca['nome'],30); ?>"><img src="../_imagens/icones/alterar-status.png" alt="Remover marca <?php echo Resumo($dados_marca['nome'],30); ?>" /></a>
                                    <a href="remover-marca.php?a=box&id=<?php echo $dados_marca['id']; ?>" rel="modal" title="Remover <?php echo $dados_marca['nome']; ?>"><img src="../_imagens/icones/fechar-grande.png" alt="Remover <?php echo $dados_marca['nome']; ?>" /></a>
                                    </td>
                                </tr>
                                <!-- FIM DO ITEM -->
                                <?php } } else { ?>
                                <tr>
                                    ...
                                    N&atilde;o h&aacute; marcas / produtores a serem exibidos
                                  </td>
                                </tr>
                                <?php } ?>
                            </tbody>

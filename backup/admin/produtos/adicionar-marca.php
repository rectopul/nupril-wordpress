<?php 
		...
		// Gera o apelido
		$apelido = GeraApelidoMarca($_POST['nome'], "-", 0);
		if($apelido == "Apelido em uso") { $erro = "62"; }
		
		// Checa se há alguma página com o mesmo nome
		$checa_nome = mysql_query("SELECT * FROM tb_marcas WHERE nome = '$nome'");
		...
		// Se inserir
		if($inserir_exec) {
		header('Location:marcas.php?sucesso=60');
		} else {
		$erro = "60";
		}
...
<title><?php echo $titulo_sistema; ?> :: Adicionar marca</title>
...
<div id="defesa">
	...
	<h1 id="barra-esquerda-titulo"><a href="#"><?php echo $titulo_sistema; ?></a></h1>
      ...
      <div id="conteudo">
			...
			<!-- INTRODUÇÃO -->
			<h2>Adicionar Marca / Produtor</h2>
			<p id="introducao">Utilize o formul&aacute;rio abaixo para adicionar uma nova marca.</p>
			...
			<div class="miolo">
				...
				<div class="miolo-conteudo">
                    ...
                    <form id="formulario-interno" class="formulario estilo" action="adicionar-marca.php" method="post">
						<fieldset>
                        ...
                        <small>Descri&ccedil;&atilde;o da marca / produtor.</small>
                        </p>

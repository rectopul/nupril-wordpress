...
switch($action) {
	...
	if ($_SERVER['REQUEST_METHOD'] == 'POST') 	{
		...
		imagejpeg($dst_r,"../../_imagens/produtos/".$nome,$jpeg_quality);
		// Salva a minitura
		imagejpeg($dst_m,"../../_imagens/produtos/miniaturas/".$nome,$jpeg_quality);
		...
		echo 1;
			...
			$dst_m = ImageCreateTrueColor( 200, 200 );
			imagesavealpha( $dst_m, true );	
			imagealphablending( $dst_m, false );
			...
			// Define o nome da imagem
			$nome_cru = GeraApelido($_POST['apelido']);
			$nome = $nome_cru."_".$_POST['ident'].".png";
			// Salva a imagem maior
			imagepng($dst_r, "../../_imagens/produtos/".$nome, 9 );
			imagepng($dst_m, "../../_imagens/produtos/miniaturas/".$nome, 9 );

<?php 
		...
		$busca_dados = mysql_query("SELECT * FROM tb_produtos WHERE id = '$id_editar'");
		...
		// Gera o apelido
		$apelido = GeraApelidoProduto($_POST['nome'], "-", $id_editar);
		if($apelido == "Apelido em uso") { $erro = "52"; }
		
		// Checa se há algum produto com o mesmo nome
		$checa_nome = mysql_query("SELECT * FROM tb_produtos WHERE nome = '$nome' AND id != '$id_editar'");
		...
		$editar = "UPDATE tb_produtos SET 	nome = '$nome',
											apelido = '$apelido',
											...
											apelido_marca = '$apelido_marca',
											id_categoria = '$id_categoria',
											nome_categoria = '$nome_categoria',
											apelido_categoria = '$apelido_categoria',
											id_subcategoria = '$id_subcategoria',
											nome_subcategoria = '$nome_subcategoria',
											apelido_subcategoria = '$apelido_subcategoria',
											id_categoria_promocional = '$id_categoria_promocional',
											nome_categoria_promocional = '$nome_categoria_promocional',
											apelido_categoria_promocional = '$apelido_categoria_promocional',
											id_pais = '$id_pais',
											nome_pais = '$nome_pais',
											apelido_pais = '$apelido_pais',
											id_regiao = '$id_regiao',
											nome_regiao = '$nome_regiao',
											apelido_regiao = '$apelido_regiao',
											pontuacao = '$pontuacao',
											tipo_uva = '$tipo_uva',
											peso = '$peso',
											altura = '$altura',
		...
		// Se editar
		if($editar_exec) {
		header('Location:index.php?sucesso=51');
		} else {
		$erro = "51";
		}
...
<title><?php echo $titulo_sistema; ?> :: Editar produto</title>
...
<div id="defesa">
	...
	<h1 id="barra-esquerda-titulo"><a href="#"><?php echo $titulo_sistema; ?></a></h1>
      ...
      <div id="conteudo">
			...
			<p id="introducao">Utilize o formul&aacute;rio abaixo para editar o produto.</p>
			  ...
			  <div class="miolo-conteudo">
                    ...
                    <form id="formulario-interno" class="formulario estilo" action="editar.php" method="post">
              		<input type="hidden" name="id" value="<?php echo $id_editar; ?>" />
                        ...
                        <option value="" <?php if($dados['destaque'] == "") { echo'selected="selected"'; } ?> >Selecione</option>
                        <option value="1" <?php if($dados['destaque'] == "1") { echo'selected="selected"'; } ?> >Sim</option>
                        <option value="2" <?php if($dados['destaque'] == "2") { echo'selected="selected"'; } ?> >N&atilde;o</option>
                        </select>
						</p>
                    ...
                    <p><label for="imagem_nome_1" class="invalido" id="erro_img">Por favor, insira uma imagem no campo abaixo [ Imagem 1 ].</label></p>
                            ...
                            <?php if ($dados['imagem_1'] != "") { echo'
                            <img src="../../_imagens/produtos/'.$dados['imagem_1'].'" width="100%" />';
                            } else { echo'
                        ...
                        <div class="segunda_linha" <?php if($dados['imagem_3'] != "") { echo'style="display:block;"'; } ?> >
                          ...
                          <div id="div_imagem_3" class="div_imagem">
                            ...
                            <img src="../../_imagens/produtos/'.$dados['imagem_3'].'" width="100%" />';
                            } else { echo'
                            ...
                            <img src="../../_imagens/produtos/'.$dados['imagem_4'].'" width="100%" />';
                            } else { echo'
                        ...
                        <div class="terceira_linha" <?php if($dados['imagem_5'] != "") { echo'style="display:block;"'; } ?> >
						  ...
						  <div id="div_imagem_5" class="div_imagem">
                            ...
                            <img src="../../_imagens/produtos/'.$dados['imagem_5'].'" width="100%" />';
                            } else { echo'
                          ...
                          <div id="div_imagem_6" class="div_imagem">
                            ...
                            <img src="../../_imagens/produtos/'.$dados['imagem_6'].'" width="100%" />';
                            } else { echo'
					  ...
					  <?php } ?>
                        ...
                        <div class="quarta_linha" <?php if($dados['imagem_7'] != "") { echo'style="display:block;"'; } ?> >
                          ...
                          <div id="div_imagem_7" class="div_imagem">
                            ...
                            <img src="../../_imagens/produtos/'.$dados['imagem_7'].'" width="100%" />';
                            } else { echo'
                          ...
                          <div id="div_imagem_8" class="div_imagem">
                            ...
                            <img src="../../_imagens/produtos/'.$dados['imagem_8'].'" width="100%" />';
                            } else { echo'
                        ...
                        <p><input class="botao grande" type="button" id="enviarform" value="Salvar Altera&ccedil;&otilde;es" />&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<input class="botao grande" type="button" onclick="window.location.href='../produtos'" value="Cancelar" /></p>
						<div class="clear"></div>
					</form>
...
<script>
var combo_select = "combo_categorias.php?tipo=categoria&id_categoria=<?php echo $dados['id_categoria']; ?>";
$(document).ready(function() {
$("#subcategoria").load('combo_categorias.php?tipo=subcategoria&categoria=<?php echo $dados['id_categoria']; ?>&id_subcategoria=<?php echo $dados['id_subcategoria']; ?>');
});
</script>
<!--[if IE 6]>

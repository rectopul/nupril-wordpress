...
<title><?php echo $titulo_sistema; ?> :: Regioes</title>
...
<div id="defesa">
	...
	<h1 id="barra-esquerda-titulo"><a href="#"><?php echo $titulo_sistema; ?></a></h1>
      ...
      <div id="conteudo">			
			<!-- INTRODUÇÃO -->
			<h2>Regi&otilde;es</h2>
            <p id="introducao">Administre aqui as regi&otilde;es de origem dos produtos da sua loja virtual</p>
            ...
            <ul class="atalhos">
                ...
                <li><a class="botao-atalho" href="adicionar-regiao.php" title="Adicionar Regiao"><span>
                <img src="../_imagens/atalhos/ad_regiao.png" alt="Adicionar Regiao" /><br />
          Adicionar Regi&atilde;o</span></a></li>
	    ...
	    <div class="clear"></div>
			...
			<div class="miolo" style="position:relative">
				...
				<div class="miolo-cabecalho">
					<h3 class="tit-longo visivel">Regi&otilde;es</h3>
                </div>
				<!-- FIM DO CABEÇALHO -->             
				...
				<div class="miolo-conteudo">
                    ...
                    <!-- LISTAGEM -->
 	  				<div class="conteudo-box"> 
                        ...
                        <!-- FILTRAGEM -->
                        <div class="filtragem">
                        <form id="formulario-filtro" class="formulario" action="regioes.php<?php echo $link_filtro; ?>" method="post">
                        ...
                        <a class="limpar" href="regioes.php<?php echo $link_filtro; ?>" title="Limpar busca">[X] Limpar</a></p>
						<?php } ?>                        
                        </form>
                        </div>
                        <!-- FIM DA FILTRAGEM -->
                          ...
                          <tfoot>
                            <tr>
                                  <td colspan="6">
                                      ...
                                      <!-- PAGINAÇÃO -->
                                      <div class="paginacao">
                                          <?php if($ini_busca !=0) { ?><a href="regioes.php<?php echo $link_paginacao; ?>&ini=<?=$anterior_ini?>" title="P&aacute;gina anterior">&laquo; Anterior</a><? } 
										  ...
										  ?>
                                          <a href="regioes.php<?php echo $link_paginacao; ?>&ini=<?=$pagina_contagem?>" class="numero <?php echo $class_ativa; ?>" title="<?php echo $i; ?>"><?php echo $i; ?></a>
                                          <?php } if($num_resul_total > $proximo_ini) { ?>
                                          <a href="regioes.php<?php echo $link_paginacao; ?>&ini=<?=$proximo_ini?>" title="Pr&oacute;xima p&aacute;gina">Pr&oacute;xima &raquo;</a>
                                          <?php } ?>
                                      </div>
                                      <!-- FIM DA PAGINAÇÃO -->
                                      <?php } ?>
                            ...
                            <tbody>
								...
								while($dados_regiao = mysql_fetch_array($busca_visual)) { 							

								?>
                            	<!-- ITEM -->
                              	<tr>
                                  	<td title="<?php echo $dados_regiao['descricao']; ?>"><?php echo Resumo($dados_regiao['nome'],30); ?></td>
                                    <td><?php echo Resumo($dados_regiao['nome_pais_mae'],30); ?></td>
                                    <td><?php echo DataSimples($dados_regiao['data_cadastro']); ?></a></td>
                                    <td><?php echo Resumo($dados_regiao['nome_responsavel'],30); ?></td>
                                    <td><?php echo ucfirst($dados_regiao['status']); ?></td>
                                    <td>                                    
                                    <a href="editar-regiao.php?id=<?php echo $dados_regiao['id']; ?>" title="Editar <?php echo $dados_regiao['nome']; ?>"><img src="../_imagens/icones/editar.png" alt="Editar <?php echo Resumo($dados_regiao['nome'],30); ?>" /></a>
                                    <a href="status-regiao.php?a=box&id=<?php echo $dados_regiao['id']; ?>" rel="modal" title="Alterar status da regiao <?php echo Resumo($dados_regiao['nome'],30); ?>"><img src="../_imagens/icones/alterar-status.png" alt="Remover regiao <?php echo Resumo($dados_regiao['nome'],30); ?>" /></a>
                                    <a href="remover-regiao.php?a=box&id=<?php echo $dados_regiao['id']; ?>" rel="modal" title="Remover <?php echo $dados_regiao['nome']; ?>"><img src="../_imagens/icones/fechar-grande.png" alt="Remover <?php echo $dados_regiao['nome']; ?>" /></a>
                                    </td>
                                </tr>
                                <!-- FIM DO ITEM -->
                                <?php } } else { ?>
                                <tr>
                                    ...
                                    N&atilde;o h&aacute; regi&otilde;es a serem exibidas
                                  </td>
                                </tr>
                                <?php } ?>
                            </tbody>

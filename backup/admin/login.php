                ...
                <!-- FIM DAS NOTIFICAÇÕES  -->
				  ...
				  <p>
				    <label>Usu&aacute;rio:</label>
						<input name="usuario" type="text" class="input-texto required" maxlength="12" minlength="3" />
					</p>
					<div class="clear"></div>
					<p>
						<label>Senha:</label>
						<input name="senha" type="password" class="input-texto required" maxlength="8" minlength="4" />
					</p>
					<div class="clear"></div>

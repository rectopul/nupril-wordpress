...
function ajaxFileUpload1()
	{
		...
		(
			{
				url:'enviar-imagem-dica.php?action=upload&id=1',
				secureuri:false,
				fileElementId:'file1',
				dataType: 'json',
	...
	function crop1() {
		...
		$.ajax({
			   type: "POST",
			   url:"enviar-imagem-dica.php?action=crop",
			   ...
			   success: function(msg){
				   ...
				   $("#crop_preview1").html($(document.createElement("img")).attr({
																				 src: '../../_imagens/dicas/' + $('#apelido1').val() + '_' + $('#ident1').val() +'.jpg',
																				 title: 'Imagem 1',
																				 alt: 'Imagem 1'})).fadeIn();
				   $("#image1").fadeOut();
...
function ajaxFileUpload2()
	{
		...
		(
			{
				url:'enviar-imagem-dica.php?action=upload&id=2',
				secureuri:false,
				fileElementId:'file2',
				dataType: 'json',
				success: function (data, status)
		...
		$.ajax({
			   ...
			   success: function(msg){
				   ...
				   $("#crop_preview2").html($(document.createElement("img")).attr({
																				 src: '../../_imagens/dicas/' + $('#apelido2').val() + '_' + $('#ident2').val() +'.jpg',
																				 title: 'Imagem 2',
																				 alt: 'Imagem 2'})).fadeIn();
				   $("#image2").fadeOut();
...
function ajaxFileUpload3()
	{
		...
		(
			{
				url:'enviar-imagem-dica.php?action=upload&id=3',
				secureuri:false,
				fileElementId:'file3',
				dataType: 'json',
				success: function (data, status)
		...
		$.ajax({
			   ...
			   success: function(msg){
				   ...
				   $("#crop_preview3").html($(document.createElement("img")).attr({
																				 src: '../../_imagens/dicas/' + $('#apelido3').val() + '_' + $('#ident3').val() +'.jpg',
																				 title: 'Imagem 3',
																				 alt: 'Imagem 3'})).fadeIn();
				   $("#image3").fadeOut();
...
function ajaxFileUpload4()
	{
		...
		(
			{
				url:'enviar-imagem-dica.php?action=upload&id=4',
				secureuri:false,
				fileElementId:'file4',
				dataType: 'json',
				success: function (data, status)
		...
		$.ajax({
			   ...
			   success: function(msg){
				   ...
				   $("#crop_preview4").html($(document.createElement("img")).attr({
																				 src: '../../_imagens/dicas/' + $('#apelido4').val() + '_' + $('#ident4').val() +'.jpg',
																				 title: 'Imagem 4',
																				 alt: 'Imagem 4'})).fadeIn();
				   $("#image4").fadeOut();
...
function ajaxFileUpload5()
	{
		...
		(
			{
				url:'enviar-imagem-dica.php?action=upload&id=5',
				secureuri:false,
				fileElementId:'file5',
				dataType: 'json',
				success: function (data, status)
		...
		$.ajax({
			   ...
			   success: function(msg){
				   ...
				   $("#crop_preview5").html($(document.createElement("img")).attr({
																				 src: '../../_imagens/dicas/' + $('#apelido5').val() + '_' + $('#ident5').val() +'.jpg',
																				 title: 'Imagem 5',
																				 alt: 'Imagem 5'})).fadeIn();
				   $("#image5").fadeOut();
...
function ajaxFileUpload6()
	{
		...
		(
			{
				url:'enviar-imagem-dica.php?action=upload&id=6',
				secureuri:false,
				fileElementId:'file6',
				dataType: 'json',
				success: function (data, status)
		...
		$.ajax({
			   ...
			   success: function(msg){
				   ...
				   $("#crop_preview6").html($(document.createElement("img")).attr({
																				 src: '../../_imagens/dicas/' + $('#apelido6').val() + '_' + $('#ident6').val() +'.jpg',
																				 title: 'Imagem 6',
																				 alt: 'Imagem 6'})).fadeIn();
				   $("#image6").fadeOut();
...
function ajaxFileUpload7()
	{
		...
		(
			{
				url:'enviar-imagem-dica.php?action=upload&id=7',
				secureuri:false,
				fileElementId:'file7',
				dataType: 'json',
				success: function (data, status)
		...
		$.ajax({
			   ...
			   success: function(msg){
				   ...
				   $("#crop_preview7").html($(document.createElement("img")).attr({
																				 src: '../../_imagens/dicas/' + $('#apelido7').val() + '_' + $('#ident7').val() +'.jpg',
																				 title: 'Imagem 7',
																				 alt: 'Imagem 7'})).fadeIn();
				   $("#image7").fadeOut();
...
function ajaxFileUpload8()
	{
		...
		(
			{
				url:'enviar-imagem-dica.php?action=upload&id=8',
				secureuri:false,
				fileElementId:'file8',
				dataType: 'json',
				success: function (data, status)
		...
		$.ajax({
			   ...
			   success: function(msg){
				   ...
				   $("#crop_preview8").html($(document.createElement("img")).attr({
																				 src: '../../_imagens/dicas/' + $('#apelido8').val() + '_' + $('#ident8').val() +'.jpg',
																				 title: 'Imagem 8',
																				 alt: 'Imagem 8'})).fadeIn();
				   $("#image8").fadeOut();

...
<title><?php echo $titulo_sistema; ?>:: Dicas</title>
...
<div id="defesa">
	...
	<h1 id="barra-esquerda-titulo"><a href="#"><?php echo $titulo_sistema; ?></a></h1>
      ...
      <div id="conteudo">			
			<!-- INTRODUÇÃO -->
			<h2>Dicas</h2>
            <p id="introducao">Administre as suas dicas.</p>
            ...
            <ul class="atalhos">
				...
				<li><a class="botao-atalho" href="adicionar.php" title="Adicionar Dica"><span>
					<img src="../_imagens/atalhos/ad_documento.png" alt="Adicionar Dica" /><br />
					Adicionar Dica
    	    </span></a></li>
...
<div class="clear"></div>
			...
			<div class="miolo" style="position:relative">
				...
				<div class="miolo-cabecalho">
					<h3 class="tit-longo visivel">Dicas</h3>
                </div>
				<!-- FIM DO CABEÇALHO -->             
                    ...
                    <!-- LISTAGEM -->
 	  				<div class="conteudo-box"> 
                        ...
                        <select name="ordem" >
                            ...
                            <option value="nome_az" <?php if($ordem == "nome_az") { echo'selected="selected"'; } ?> >T&iacute;tulo- A &raquo; Z</option>
                            <option value="nome_za" <?php if($ordem == "nome_za") { echo'selected="selected"'; } ?> >T&iacute;tulo - Z &raquo; A</option>
                         </select>
                        ...
                        <table>
                          <thead>
                              <tr>
                                 ...
                                 <th>T&iacute;tulo</th>
                                 <th>Data da inser&ccedil;&atilde;o</th>
                          ...
                          <tfoot>
                                  ...
                                  <td colspan="4">
                                      <div class="acao-lote alinhar-esquerda">
                                          <select name="acao" class="required">
                                              ...
                                              <option value="remover-dicas-lote">Remover</option>
                                          </select>  
                            ...
                            <tbody>
								...
								while($dados_foto = mysql_fetch_array($busca_visual)) {
									
								// Trabalha o estoque
								$class_estoque = "";
								if($dados_foto['estoque'] <= $nivel_atencao_sistema) { $class_estoque = 'atencao'; }
								if($dados_foto['estoque'] <= $nivel_critico_sistema) { $class_estoque = 'critico'; }
								if($dados_foto['estoque'] > $nivel_atencao_sistema) { $class_estoque = 'regular'; }

								?>
                            	<!-- ITEM -->
                              	<tr>
                                    <td><input type="checkbox" name="item[<?php echo $dados_foto['id']; ?>]" /></td>
                                    <td><?php echo Resumo($dados_foto['nome'],30); ?></td>
                                    <td><?php echo DataSimples($dados_foto['data_cadastro']); ?></td>
                                    <td>                                  
                                    <a href="editar.php?id=<?php echo $dados_foto['id']; ?>" title="Editar <?php echo $dados_foto['nome']; ?>"><img src="../_imagens/icones/editar.png" alt="Editar <?php echo $dados_foto['nome']; ?>" /></a>
                                    <a href="index.php<?php echo $link; if($ini_busca != 0) { echo '&ini='.$ini_busca; } ?>&acao=remover-foto&id=<?php echo $dados_foto['id']; ?>" title="Remover <?php echo $dados_foto['nome']; ?>" onClick="return window.confirm('Você tem certeza que deseja remover a foto <?php echo $dados_foto['nome']; ?> ?');"><img src="../_imagens/icones/fechar-grande.png" alt="Remover <?php echo $dados_foto['nome']; ?>" /></a>
                                    </td>
                                </tr>
                                <!-- FIM DO ITEM -->
                                <?php } } else { ?>
                                <tr>
                                    ...
                                    N&atilde;o h&aacute; dicas a serem exibidas
                                  </td>
                                </tr>
                                <?php } ?>
                            </tbody>

<?php 
		...
		$nome_responsavel = $_SESSION['AQUACENTER_NOME'];
		...
		// Gera o apelido
		$apelido = GeraApelidoDica($_POST['nome'], "-", 0);
		if($apelido == "Apelido em uso") { $erro = "82"; }
		
		// Checa se há algum foto com o mesmo nome
		$checa_nome = mysql_query("SELECT * FROM tb_dicas WHERE nome = '$nome'");
		...
		// Se inserir
		if($inserir_exec) {
		header('Location:index.php?sucesso=85');
		} else {
		$erro = "85";
		}
...
<title><?php echo $titulo_sistema; ?>:: Adicionar dica</title>
	...
	<h1 id="barra-esquerda-titulo"><a href="#"><?php echo $titulo_sistema; ?></a></h1>
	  ...
	  <div id="links-perfil">
        ...
        <div id="conteudo">
			...
			<!-- INTRODUÇÃO -->
			<h2>Adicionar Dicas</h2>
			<p id="introducao">Utilize o formul&aacute;rio abaixo para adicionar novas dicas.</p>
			...
			<div class="miolo">
				...
				<div class="miolo-conteudo">
                    ...
                    <input type="hidden" name="imagem_nome_1" id="imagem_nome_1" value="'.$imagem_1.'" />';
                    } else { echo'
                    ...
                    <p><label for="imagem_nome_1" class="invalido" id="erro_img">Por favor, insira uma imagem no campo abaixo [ Imagem 1 ].</label></p>
                            ...
                            <?php if ($imagem_1 != "") { echo'
                            <img src="../../_imagens/dicas/'.$imagem_1.'" width="100%" />';
                            } else { echo'
                        ...
                        <div class="segunda_linha" <?php if($imagem_3 != "") { echo'style="display:block;"'; } ?> >
                          ...
                          <div id="div_imagem_3" class="div_imagem">
                            ...
                            <img src="../../_imagens/dicas/'.$imagem_3.'" width="100%" />';
                            } else { echo'
                          ...
                          <div id="div_imagem_4" class="div_imagem">
                            ...
                            <img src="../../_imagens/dicas/'.$imagem_4.'" width="100%" />';
                            } else { echo'
                    ...
                    <div class="terceira_linha" <?php if($imagem_5 != "") { echo'style="display:block;"'; } ?> >
						  ...
						  <div id="div_imagem_5" class="div_imagem">
                            ...
                            <img src="../../_imagens/dicas/'.$imagem_5.'" width="100%" />';
                            } else { echo'
                          ...
                          <div id="div_imagem_6" class="div_imagem">
                            ...
                            <img src="../../_imagens/dicas/'.$imagem_6.'" width="100%" />';
                            } else { echo'
					  ...
					  <?php } ?>
                        ...
                        <div class="quarta_linha" <?php if($imagem_7 != "") { echo'style="display:block;"'; } ?> >
                          ...
                          <div id="div_imagem_7" class="div_imagem">
                            ...
                            <img src="../../_imagens/dicas/'.$imagem_7.'" width="100%" />';
                            } else { echo'
                          ...
                          <div id="div_imagem_8" class="div_imagem">
                            ...
                            <img src="../../_imagens/dicas/'.$imagem_8.'" width="100%" />';
                            } else { echo'
                        ...
                        <p><input class="botao grande" type="button"  id="enviarform" value="Adicionar Dica" />&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<input class="botao grande" type="button" onclick="window.location.href='../dicas'" value="Cancelar" /></p>
						<div class="clear"></div>
					</form>

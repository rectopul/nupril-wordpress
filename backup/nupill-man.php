<?
	...
	//Busca subcategorias
	$busca_subcategorias = mysql_query("SELECT * FROM tb_subcategorias WHERE categoria_mae = '$id_categoria' ORDER BY nome ASC");
...
<li><a class="myriad_regular" href="fale-conosco.php">FALE CONOSCO</a></li>    
  ...
  <div id="banner" class="nupill_man">
  <img src="_imagens/banner_nupill_man.jpg" class="visible_mobile" height="auto" width="100%">
  </div>
...
<div id="conteudo">
  ...
  <div id="defesa">
   ...
   <br class="limpa_float" />
    ...
    <li><a href="nupill-man.php" title="Nupill Man"><img src="_imagens/categorias/nupill-man.jpg" width="150" height="135" alt="Nupill Man" /></a></li>

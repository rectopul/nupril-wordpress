...
<title>Nupill - Cuidado Facial</title>
<!-- FOLHAS DE ESTILO -->
...
<li><a class="myriad_regular" href="fale-conosco.php">FALE CONOSCO</a></li>    
  ...
  <div id="banner" class="cuidado_facial">
  <img src="_imagens/banner_cuidado_facial.jpg" class="visible_mobile" height="auto" width="100%">
  </div>
...
<div id="conteudo">
  ...
  <div id="defesa">
	...
	?>
    <li><a href="ver-produtos.php?categoria=<?=$categoria?>&subcategoria=<?=$dados_subcategorias['apelido']?>" class="higher myriad_regular"><?=$dados_subcategorias['nome']?></a></li>
    <? } ?>
    ...
    <br class="limpa_float" />
    <p><img src="_imagens/4_passos.jpg" width="960" height="266" /></p>
    <p>&nbsp;</p>
